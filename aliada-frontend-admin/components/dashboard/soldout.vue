<template>
    <div class="col-xl-5 xl-12">
        <div class="card expiring-card">
            <div class="card-header">
                <div class="d-flex">
                    <h5>Vendidos</h5>
                    <nuxt-link to="/type/appartment" class="arrow-animated">
                        Ver detalles
                       <Icon name="material-symbols:chevron-right" class="fs-3"/>
                    </nuxt-link>
                </div>
            </div>
                        ...
                        <div class="media">
                           <div class="with-reload">
                            ...
                            <div class="media-body">
                                <h5>78</h5>
                                <span class="light-font">Propiedades</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="legend-exiring">
                    <ul>
                        <li>
                            ...
                            <span class="light-font">> 20 días</span>
                        </li>
                        <li>
                            <div class="d-flex">
                            ...
                            <span class="light-font">21 - 40 días</span>
                        </li>
                        <li>
                            <div class="d-flex">
                            ...
                            <span class="light-font">41 - 80 Días</span>
                        </li>
                    </ul>
                </div>
            </div>
