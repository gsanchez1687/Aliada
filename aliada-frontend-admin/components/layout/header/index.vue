        ...
        <ul class="header-menu">
            ...
            <li class="profile-avatar onhover-dropdown">
                ...
                <ul class="profile-dropdown onhover-show-div">
                    <li><nuxt-link to="/users/profile"><span>Mi Perfil </span><Icon name="mdi:account-outline" class="fs-3" /></nuxt-link></li>
                   <!--  <li><nuxt-link to="/myproperties/propertylist"><span>Propiedades</span><Icon name="mdi:file-document-outline" class="fs-3"/></nuxt-link></li> -->
                    <li><nuxt-link @click="logoutSession()"><span>Cerrar sesión</span><Icon name="mdi:login" class="fs-3"/></nuxt-link></li>
                </ul>
            </li>
        </ul>
    </div>
