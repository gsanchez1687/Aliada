<template>
    <div class="page-body">
      <CommonBreadcrumb title="Mis propiedades" page="Mis propiedades" />
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <UTabs :items="items" class="w-full-2">
                <template #item="{ item }">
                  <div v-if="item.key === 'aprobados'" class="space-y-3">
                    <div class="card-header pb-0">
                      <h5>Mostrando 1-3 de propiedades</h5>
                    </div>
                  ...
                  </div><!--fin de aprobados-->
                  <div v-if="item.key === 'mispropiedadespendieteaprobar'" class="space-y-3">
                    <div class="card-header pb-0">
                      <h5>Mostrando 1-3 de propiedades</h5>
                    </div>
                    <div class="property-2 row column-sm property-label property-grid payment-table">
                          ...
                          <table class="table table-bordered table-striped text-center table-hover cursor-pointer">
                            ...
                            <tbody>
                              ...
                              >
                                ...
                                <td>{{ property.square_meters }}</td>
                                <td class="jsgrid-cell">
                                  <span>{{ property.latest_approval.approval_state.name }}</span>
                                </td>
  ...
  const items = [{
    ...
    key: 'mispropiedadespendieteaprobar',
    label: 'Mis propiedades pendientes por aprobar',
  }];
  //fin de tabs
