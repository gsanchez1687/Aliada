<template>
  <div class="page-body">
    <CommonBreadcrumb title="Lista de propiedades" page="Mis propiedades" />
        ...
        <div class="col-lg-12">
          <div class="card">
            <UTabs :items="items" class="w-full-2">
                <template #item="{ item }">
                  <div v-if="item.key === 'lista'" class="space-y-3">
                    <div class="card-header pb-0">
                  ...
                  <div v-if="item.key === 'pendienteporaprobar'" class="space-y-3">
                    <div class="card-header pb-0">
                      <h5>Mostrando 1-3 de propiedades</h5>
                    </div>
                    <div class="property-2 row column-sm property-label property-grid payment-table">
